...
//以下为关于article的操作
const findUser = async (name,pwd) => await User.find({username:name,password:pwd}).catch((error)=>console.log(error));
...
const getLimit = async (num) => await User.find({}).limit(num).catch((error)=>console.log(error)); 
...
module.exports = {addMany,add,getLimit,delArticleByTitle,updateByID,delArticleByID,findByID,findUser};
